...
const SCORE_CARDS = [
  {
    ...
    barColor: "bg-linear-to-r from-sky-400 to-sky-600",
    dotColor: "bg-sky-500",
  },
  {
    key: "note_jury",
    ...
    barColor: "bg-linear-to-r from-emerald-400 to-emerald-600",
  ...
  },
  {
    ...
    barColor: "bg-linear-to-r from-violet-400 to-violet-600",
...
function ScoreCard({ label, hint, value, icon: Icon, gradient, iconBg, iconColor, barColor, dotColor }) {
  ...
  return (
    <div className="group relative overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm hover:shadow-md transition-all duration-300">
      <div className={`h-[3px] w-full bg-linear-to-r ${gradient} rounded-t-2xl`} />
      <div className={`pointer-events-none absolute -right-10 -top-10 h-32 w-32 rounded-full bg-linear-to-br ${gradient} opacity-0 blur-3xl transition-opacity duration-300 group-hover:opacity-[0.07]`} />
      <div className="p-5">
        <div className="flex items-start justify-between mb-5">
  ...
  return (
    <div className="min-h-screen bg-[#f7f8fa] px-6 py-7">
      ...
      <div className="max-w-5xl mx-auto space-y-7">
        ...
        <div className="relative overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-sm hover:shadow-md transition-shadow duration-300">
          <div className="h-[3px] w-full rounded-t-2xl bg-linear-to-r from-sky-400 via-violet-400 to-violet-500" />
          <div className="p-5">
            ...
            <div className="mt-4 h-[3px] w-full overflow-hidden rounded-full bg-gray-100">
              <div className="h-full w-full rounded-full bg-linear-to-r from-sky-400 via-violet-400 to-violet-500" />
            </div>
          </div>
        </div>
